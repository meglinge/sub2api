export default {
    accounts: {
      ...
      autopilotMoney: {
        ...
        upstreamKindHint: 'new-api/one-api needs a management token; sub2api panel credentials can switch groups (no CF/captcha login yet).',
        ...
        panelEmailHint: 'sub2api user panel email for /keys group changes.',
        panelPassword: 'Panel password',
        panelPasswordHint: 'Leave blank on save to keep existing. Sites with Cloudflare/captcha cannot auto-login yet.',
        groupSwitch: 'Allow AI to switch upstream group',
        groupSwitchHint: 'When on, AI may switch to a cheaper upstream group if quality gates pass (new-api token group / sub2api key group). Off by default.',
      ...
      stats: {
        ...
        cacheHitRateHint: 'Cache hit rate = cache-read tokens / (input + cache-write + cache-read). Higher means this channel hits prompt cache more often.',
