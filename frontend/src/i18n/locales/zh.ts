export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      shortTextSkip: '短文本保守跳过',
      shortTextSkipHint: '仅跳过无图片、很短且属于确认/继续/数字/标点等低风险输入；不会跳过任意短句。',
      shortTextSkipRunes: '短文本最大字符数',
      lowRiskCache: '低风险 exact 缓存',
      lowRiskCacheHint: '相同输入哈希上次审核分数低于阈值时，TTL 内直接放行，不再请求 OpenAI。',
      lowRiskCacheTTL: '缓存 TTL（秒）',
      lowRiskCacheMaxScore: '低风险最高分阈值',
      ...
      activeWorkers: '处理中',
      idleWorkers: '空闲可用',
      shortTextSkipped: '短文本跳过',
      lowRiskCacheHits: '低风险缓存命中',
