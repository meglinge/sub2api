export default {
    accounts: {
      ...
      autopilotMoney: {
        ...
        upstreamKindHint: 'new-api/one-api 需管理令牌；sub2api 面板账密可切分组（暂不支持 CF/验证码登录）。',
        mgmtToken: '管理访问令牌',
        mgmtTokenHint: 'new-api 个人中心「系统访问令牌」。留空保存 = 不改已有值。',
        mgmtUserId: '上游用户 ID',
        mgmtUserIdHint: 'new-api 请求头 New-Api-User，个人中心显示的数字 ID。',
        panelEmail: '面板邮箱',
        panelEmailHint: 'sub2api 用户面板登录邮箱（用于 /keys 改分组）。',
        panelPassword: '面板密码',
        panelPasswordHint: '留空保存 = 不改已有密码。有 Cloudflare/验证码的站暂不可自动登录。',
        groupSwitch: '允许 AI 切换上游分组',
        groupSwitchHint: '开启后 AI 可在质量达标时切换更便宜的上游组（new-api token 组 / sub2api key 组）。默认关。',
      ...
      stats: {
        ...
        cache: '缓存',
        cacheHitRate: '缓存命中率',
        cacheHitRateHint: '缓存命中率 = 缓存读取 Token / (输入 + 缓存写入 + 缓存读取)。越高说明该渠道越容易命中提示缓存。',
