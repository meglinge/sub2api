export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      model: 'Model',
      proxy: 'Request Proxy',
      proxyHint: 'Used for OpenAI Moderations API requests. Selected proxies are reused from Proxy Management instead of direct egress.',
      ...
      shortTextSkip: 'Conservative Short-Text Skip',
      shortTextSkipHint: 'Only skips image-free, very short low-risk inputs such as confirmations, continue commands, digits, or punctuation.',
      shortTextSkipRunes: 'Short Text Max Characters',
      lowRiskCache: 'Low-Risk Exact Cache',
      lowRiskCacheHint: 'When the exact input hash was previously scored below the threshold, pass it within the TTL without calling OpenAI.',
      lowRiskCacheTTL: 'Cache TTL (seconds)',
      lowRiskCacheMaxScore: 'Low-Risk Max Score',
      ...
      shortTextSkipped: 'Short Text Skipped',
      lowRiskCacheHits: 'Low-Risk Cache Hits',
