...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "ai_disabled", Type: field.TypeBool, Default: false},
		{Name: "ai_managed", Type: field.TypeBool, Default: true},
		{Name: "ai_watched", Type: field.TypeBool, Default: false},
		{Name: "schedule_weight", Type: field.TypeInt, Default: 10},
		{Name: "manual_touched_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
