	...
	m, err := r.activeQuery().
		...
		WithGroup(func(q *dbent.GroupQuery) {
			q.Select(
				...
				group.FieldOpenaiForceCodex,
				group.FieldCodexProtectionEnabled,
				group.FieldCodexInstructionGuardPrompt,
				group.FieldCodexHardBlockReply,
...
func groupEntityToService(g *dbent.Group) *service.Group {
	...
	return &service.Group{
		...
		CodexProtectionEnabled:          g.CodexProtectionEnabled,
		CodexInstructionGuardPrompt:     derefString(g.CodexInstructionGuardPrompt),
		CodexHardBlockReply:             derefString(g.CodexHardBlockReply),
