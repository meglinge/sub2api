...
func (r *stubAccountRepoForHandler) ListAllWithFilters(ctx context.Context, platform, accountType, status, search string, groupID int64, privacyMode string) ([]service.Account, int64, error) {
	return nil, 0, nil
}
