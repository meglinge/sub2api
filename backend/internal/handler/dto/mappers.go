...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		AIDisabled:              a.AIDisabled,
		AIManaged:               a.AIManaged,
		AIWatched:               a.AIWatched,
		ScheduleWeight:          a.EffectiveScheduleWeight(),
		ManualTouchedAt:         a.ManualTouchedAt,
...
func AccountListItemFromAccount(a *Account) *AccountListItem {
	...
	return &AccountListItem{
		...
		AIDisabled: a.AIDisabled, AIManaged: a.AIManaged, AIWatched: a.AIWatched,
		ScheduleWeight: a.ScheduleWeight, ManualTouchedAt: a.ManualTouchedAt,
