...
func applyCodexOAuthTransform(reqBody map[string]any, isCodexCLI bool, isCompactRequest ...bool) codexTransformResult {
	compact := false
	if len(isCompactRequest) > 0 {
		compact = isCompactRequest[0]
	}
	return applyCodexOAuthTransformByRequestType(reqBody, isCodexCLI, compact)
}
