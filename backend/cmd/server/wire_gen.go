...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	aiPilotRepository := repository.NewAIPilotRepository(db)
	aiPilotService := service.ProvideAIPilotService(settingService, accountRepository, groupRepository, aiPilotRepository)
	aiPilotHandler := admin.NewAIPilotHandler(aiPilotService, settingService)
	codexTurnStateHandler := admin.NewCodexTurnStateHandler(openAIGatewayService, settingService, adminService)
	upstreamBillingProbeService := service.ProvideUpstreamBillingProbeService(accountRepository, accountTestService, settingService, leaderLockCache, db)
	ollamaCloudUsageService := service.ProvideOllamaCloudUsageService(accountRepository, httpUpstream, settingService, secretEncryptor, configConfig, leaderLockCache, db)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, aiPilotHandler, codexTurnStateHandler, upstreamBillingProbeService, ollamaCloudUsageService)
